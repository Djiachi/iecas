...
import com.tansun.ider.bus.impl.X5986BusImpl;
 ...
 */
@Service("X5986")
public class X5986ActionImpl implements ActionService {

    @Resource
    private X5986BusImpl x5986BusImpl;
    ...
    public Object execute(Map<String, Object> map) throws Exception {
        ...
        return x5986BusImpl.busExecute(x5982BO);
    }
