...
import com.tansun.ider.bus.impl.X5116BusImpl;
 ...
 */
@Service("X5116")
public class X5116ActionImpl implements ActionService {

    @Resource
    private X5116BusImpl x5116BusImpl;
    ...
    public Object execute(Map<String, Object> map) throws Exception {
        ...
        return x5116BusImpl.busExecute(x5115BO);
    }
