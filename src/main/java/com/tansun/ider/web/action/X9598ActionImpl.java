...
import com.tansun.ider.bus.impl.X9598BusImpl;
 ...
 */
@Service("X9598")
public class X9598ActionImpl implements ActionService {

    @Resource
    private X9598BusImpl x9598BusImpl;
    ...
    public Object execute(Map<String, Object> map) throws Exception {
        ...
        return x9598BusImpl.busExecute(x9598BO);
    }
