...
public class AuthEventCommAreaNonFinanceBean {
    ...
    //Cycle Refresh日期
    private String cycleRefreshDate;
    private List<AuthEventCommAreaNonFinanceBean> auths;
	...
	public String getCycleRefreshDate() {
		return cycleRefreshDate;
	}
	public void setCycleRefreshDate(String cycleRefreshDate) {
		this.cycleRefreshDate = cycleRefreshDate;
	}
	public List<AuthEventCommAreaNonFinanceBean> getAuths() {
		return auths;
	}
	public void setAuths(List<AuthEventCommAreaNonFinanceBean> auths) {
		this.auths = auths;
	}
}
