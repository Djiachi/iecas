...
public class X5050BO {
    ...
    /** 主产品形式代码 */
	private String mainProductFrom;
	/** 设备编号 */
	...
	public String getMainProductFrom() {
		return mainProductFrom;
	}

	public void setMainProductFrom(String mainProductFrom) {
		this.mainProductFrom = mainProductFrom;
	}
