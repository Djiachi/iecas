...
public class X5425BO extends BeanVO implements Serializable{

	private static final long serialVersionUID = -8219529472596285139L;
	/** 区别新增一条记录还是多条记录 1:一条,2:多条 */
	private String addFlag;
	/** 定价标签 */
	private List<CoreCustomerBusinessType> coreCustomerBusinessTypeList;
	/** 事件编号 [14,0] Not NULL */
    ...
    /** 定价对象 [3,0] */
    protected String pricingObject;
    /** 定价对象代码 [3,0] */
    protected String pricingObjectCode;
    /** 标签生效日期 [10,0] */
    protected String custTagEffectiveDate;
    /** 标签失效日期 [10,0] */
    protected String custTagExpirationDate;
    /** 定价层级 [1,0] */
    protected String pricingLevel;
    /** 定价层级代码 [12,0] */
    protected String pricingLevelCode;
	/** 产品形式代码 */
	...
	public List<CoreCustomerBusinessType> getCoreCustomerBusinessTypeList() {
		return coreCustomerBusinessTypeList;
	}
	public void setCoreCustomerBusinessTypeList(List<CoreCustomerBusinessType> coreCustomerBusinessTypeList) {
		this.coreCustomerBusinessTypeList = coreCustomerBusinessTypeList;
	}
