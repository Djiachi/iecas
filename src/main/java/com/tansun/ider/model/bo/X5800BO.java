...
import com.tansun.ider.model.vo.X5800VO;
 ...
 * @date 2018年7月3日
 */
public class X5800BO {

	/**
	 * 序列化
	 */
	private static final long serialVersionUID = -373431519494347217L;
	/** 活动编号 [8,0] Not NULL */
	 ...
	 *            the list to set
	 */
	public void setList(List<X5800VO> list) {
		this.list = list;
	}
	...
	public String toString() {
		return "X5800BO [activityNo=" + activityNo + ", eventNo=" + eventNo + ", operatorId=" + operatorId
				...
				+ creditNodeNo + ", creditLimit=" + creditLimit + ", coreEventActivityRel=" + coreEventActivityRel
				+ ", activityArtifactList=" + activityArtifactList + ", globalEventNo=" + globalEventNo
				+ ", ecommEventId=" + ecommEventId + ", customerNo=" + customerNo + ", institutionId=" + institutionId
				...
				+ ", lastUpdateDate=" + lastUpdateDate + ", businessType=" + businessType + ", productObjectCode="
				+ productObjectCode + ", pricingType=" + pricingType + ", pricingTag=" + pricingTag + ", effectiveDate="
				+ effectiveDate + ", tagExpirationDate=" + tagExpirationDate + ", balanceType=" + balanceType
				+ ", branchNumber=" + branchNumber + ", dateOfBirth=" + dateOfBirth + ", mobilePhone=" + mobilePhone
				+ ", zipCode=" + zipCode + ", homePhone=" + homePhone + ", companyPhone=" + companyPhone
				+ ", contactPhone=" + contactPhone + ", contactName=" + contactName + ", memberSince=" + memberSince
				+ ", customerSource=" + customerSource + ", behaviorScore=" + behaviorScore + ", customerLevel="
				+ customerLevel + ", annualIncome=" + annualIncome + ", sexCode=" + sexCode + ", residencyStatus="
				+ residencyStatus + ", maritalStatus=" + maritalStatus + ", occupationCode=" + occupationCode
				+ ", postRankCode=" + postRankCode + ", titleCode=" + titleCode + ", periodOfOccupation="
				+ periodOfOccupation + ", hobby=" + hobby + ", guarantorFlag=" + guarantorFlag + ", marketerCode="
				+ marketerCode + ", socialSecurityId=" + socialSecurityId + ", socialSecurityNumber="
				+ socialSecurityNumber + ", coreCustomerRemarkss=" + coreCustomerRemarkss
				...
				+ currentCycleNumber + ", totalAmtDue=" + totalAmtDue + ", flag=" + flag + ", type=" + type
				+ ", permLimit=" + permLimit + ", accountNo=" + accountNo + ", currencyCode=" + currencyCode
				+ ", trialDate=" + trialDate + ", totalAmount=" + totalAmount + ", principal=" + principal
				+ ", interest=" + interest + ", fee=" + fee + ", list=" + list + "]";
	}
