...
public class X5560BO extends BeanVO implements Serializable{
	...
	/** 余额单元代码  */
	@NotBlank(message = "余额单元代码必须输入! ")
	private String balanceUnitCode;
	/** 发生额 */
	private BigDecimal occurrAmount;
	/** 利息结束日期 */
	@NotBlank(message = "利息结束日期必须输入! ")
	private String billingEndDate;
	/** 起息日期 */
	@NotBlank(message = "起息日期必须输入! ")
	...
	public String toString() {
		return "X5560BO [occurrDate=" + occurrDate + ", nodeTyp=" + nodeTyp + ", nodeStatus=" + nodeStatus
				+ ", currInterestAmount=" + currInterestAmount + ", lastInterestAmount=" + lastInterestAmount
				+ ", billingCycleNo=" + billingCycleNo + ", billingStartDate=" + billingStartDate
				+ ", currInterestPostFlag=" + currInterestPostFlag + ", interestPostBalanceObj="
				+ interestPostBalanceObj + ", postingCurrencyCode=" + postingCurrencyCode + ", interestAmount="
				+ interestAmount + ", balanceUnitCode=" + balanceUnitCode + ", occurrAmount=" + occurrAmount
				+ ", billingEndDate=" + billingEndDate + ", interestStartDate=" + interestStartDate + ", paymentMark="
				+ paymentMark + ", retailVerifyPswFlag=" + retailVerifyPswFlag + ", retailVerifyPswAmount="
				+ retailVerifyPswAmount + ", contactAddress=" + contactAddress + ", contactPostCode=" + contactPostCode
				...
				+ totalAmtDue + ", flag=" + flag + ", type=" + type + ", permLimit=" + permLimit + "]";
	}
