...
public class X5570BO extends BeanVO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6000800589291685779L;
	/** 顺序号  */
	...
	public String toString() {
		return "X5570BO [balanceUnitCode=" + balanceUnitCode + ", interestStartDate=" + interestStartDate + ", nodeTyp="
				+ nodeTyp + ", globalTransSerialNo=" + globalTransSerialNo + ", paymentMark=" + paymentMark
				+ ", retailVerifyPswFlag=" + retailVerifyPswFlag + ", retailVerifyPswAmount=" + retailVerifyPswAmount
				+ ", contactAddress=" + contactAddress + ", contactPostCode=" + contactPostCode
				+ ", contactMobilePhone=" + contactMobilePhone + ", SystemUnitNo=" + SystemUnitNo + ", creditNodeNo="
				+ creditNodeNo + ", creditLimit=" + creditLimit + ", currencyCode=" + currencyCode
				+ ", coreEventActivityRel=" + coreEventActivityRel + ", activityArtifactList=" + activityArtifactList
				+ ", globalEventNo=" + globalEventNo + ", ecommEventId=" + ecommEventId + ", customerNo=" + customerNo
				+ ", institutionId=" + institutionId + ", operationMode=" + operationMode + ", customerName="
				+ customerName + ", idType=" + idType + ", idNumber=" + idNumber + ", city=" + city + ", customerType="
				+ customerType + ", billDay=" + billDay + ", customerStatus=" + customerStatus
				+ ", coreCoreCustomerAddrs=" + coreCoreCustomerAddrs + ", remarkInfo=" + remarkInfo
				+ ", lastUpdateUserid=" + lastUpdateUserid + ", serialNo=" + serialNo + ", lastUpdateDate="
				+ lastUpdateDate + ", businessType=" + businessType + ", productObjectCode=" + productObjectCode
				+ ", pricingType=" + pricingType + ", pricingTag=" + pricingTag + ", effectiveDate=" + effectiveDate
				+ ", tagExpirationDate=" + tagExpirationDate + ", balanceType=" + balanceType + ", branchNumber="
				+ branchNumber + ", dateOfBirth=" + dateOfBirth + ", mobilePhone=" + mobilePhone + ", zipCode="
				+ zipCode + ", homePhone=" + homePhone + ", companyPhone=" + companyPhone + ", contactPhone="
				+ contactPhone + ", contactName=" + contactName + ", memberSince=" + memberSince + ", customerSource="
				+ customerSource + ", behaviorScore=" + behaviorScore + ", customerLevel=" + customerLevel
				+ ", annualIncome=" + annualIncome + ", sexCode=" + sexCode + ", residencyStatus=" + residencyStatus
				+ ", maritalStatus=" + maritalStatus + ", occupationCode=" + occupationCode + ", postRankCode="
				+ postRankCode + ", titleCode=" + titleCode + ", periodOfOccupation=" + periodOfOccupation + ", hobby="
				+ hobby + ", guarantorFlag=" + guarantorFlag + ", marketerCode=" + marketerCode + ", socialSecurityId="
				+ socialSecurityId + ", socialSecurityNumber=" + socialSecurityNumber + ", coreCustomerRemarkss="
				+ coreCustomerRemarkss + ", coreCustomerBusinessTypes=" + coreCustomerBusinessTypes
				+ ", productUnitCode=" + productUnitCode + ", productLineCode=" + productLineCode
				+ ", postingCurrency1=" + postingCurrency1 + ", postingCurrency2=" + postingCurrency2
				+ ", postingCurrency3=" + postingCurrency3 + ", postingCurrency4=" + postingCurrency4
				+ ", postingCurrency5=" + postingCurrency5 + ", postingCurrency6=" + postingCurrency6
				+ ", postingCurrency7=" + postingCurrency7 + ", postingCurrency8=" + postingCurrency8
				+ ", postingCurrency9=" + postingCurrency9 + ", postingCurrency10=" + postingCurrency10
				+ ", coBrandedNo=" + coBrandedNo + ", mediaUnitCode=" + mediaUnitCode + ", mediaObjectCode="
				+ mediaObjectCode + ", externalIdentificationNo=" + externalIdentificationNo + ", mainCustomerNo="
				+ mainCustomerNo + ", subCustomerNo=" + subCustomerNo + ", mainSupplyIndicator=" + mainSupplyIndicator
				+ ", mediaUserName=" + mediaUserName + ", applicationStaffNo=" + applicationStaffNo
				+ ", applicationNumber=" + applicationNumber + ", expirationDate=" + expirationDate
				+ ", previousExpirationDate=" + previousExpirationDate + ", pinDispatchMethod=" + pinDispatchMethod
				+ ", mediaDispatchMethod=" + mediaDispatchMethod + ", statusCode=" + statusCode + ", activationFlag="
				+ activationFlag + ", activationDate=" + activationDate + ", createDate=" + createDate
				+ ", embosserName1=" + embosserName1 + ", embosserName2=" + embosserName2 + ", embosserName3="
				+ embosserName3 + ", embosserName4=" + embosserName4 + ", productionCode=" + productionCode
				+ ", productionDate=" + productionDate + ", previousProductionCode=" + previousProductionCode
				+ ", previousProductionDate=" + previousProductionDate + ", formatCode=" + formatCode
				+ ", accountCurrency=" + accountCurrency + ", modeName=" + modeName + ", lastProcessDate="
				+ lastProcessDate + ", currProcessDate=" + currProcessDate + ", nextProcessDate=" + nextProcessDate
				+ ", operationDate=" + operationDate + ", creditTreeId=" + creditTreeId + ", excessPymtBusinessType="
				+ excessPymtBusinessType + ", coreMediaLabelInfos=" + coreMediaLabelInfos + ", bindId=" + bindId
				+ ", bindDate=" + bindDate + ", unbindDate=" + unbindDate + ", nextBillDate=" + nextBillDate
				+ ", isTransferCard=" + isTransferCard + ", nonLogId=" + nonLogId + ", id=" + id + ", accountId="
				+ accountId + ", businessTypeCode=" + businessTypeCode + ", organNo=" + organNo
				+ ", accountOrganizeTyp=" + accountOrganizeTyp + ", businessDebitCreditCode=" + businessDebitCreditCode
				+ ", cycleModeFlag=" + cycleModeFlag + ", statusUpdateDate=" + statusUpdateDate + ", closedDate="
				+ closedDate + ", interestProcessDate=" + interestProcessDate + ", paymentDueDate=" + paymentDueDate
				+ ", delinquencyDate=" + delinquencyDate + ", accountingStatusCode=" + accountingStatusCode
				+ ", accountingStatusDate=" + accountingStatusDate + ", prevAccountingStatusCode="
				+ prevAccountingStatusCode + ", prevAccountingStatusDate=" + prevAccountingStatusDate
				+ ", directDebitType=" + directDebitType + ", cycleDue=" + cycleDue + ", prevCycleDue=" + prevCycleDue
				+ ", absStatus=" + absStatus + ", currentCycleNumber=" + currentCycleNumber + ", totalAmtDue="
				+ totalAmtDue + ", flag=" + flag + ", type=" + type + ", permLimit=" + permLimit + ", getPaymentMark()="
				+ getPaymentMark() + ", getRetailVerifyPswFlag()=" + getRetailVerifyPswFlag()
				+ ", getRetailVerifyPswAmount()=" + getRetailVerifyPswAmount() + ", getContactAddress()="
				+ getContactAddress() + ", getContactPostCode()=" + getContactPostCode() + ", getContactMobilePhone()="
				+ getContactMobilePhone() + ", getSystemUnitNo()=" + getSystemUnitNo() + ", getCreditNodeNo()="
				+ getCreditNodeNo() + ", getCreditLimit()=" + getCreditLimit() + ", getCurrencyCode()="
				+ getCurrencyCode() + ", getCoreEventActivityRel()=" + getCoreEventActivityRel()
				+ ", getActivityArtifactList()=" + getActivityArtifactList() + ", getGlobalEventNo()="
				+ getGlobalEventNo() + ", getEcommEventId()=" + getEcommEventId() + ", getCustomerNo()="
				+ getCustomerNo() + ", getInstitutionId()=" + getInstitutionId() + ", getOperationMode()="
				+ getOperationMode() + ", getCustomerName()=" + getCustomerName() + ", getIdType()=" + getIdType()
				+ ", getIdNumber()=" + getIdNumber() + ", getCity()=" + getCity() + ", getCustomerType()="
				+ getCustomerType() + ", getBillDay()=" + getBillDay() + ", getCustomerStatus()=" + getCustomerStatus()
				+ ", getCoreCoreCustomerAddrs()=" + getCoreCoreCustomerAddrs() + ", getRemarkInfo()=" + getRemarkInfo()
				+ ", getLastUpdateUserid()=" + getLastUpdateUserid() + ", getSerialNo()=" + getSerialNo()
				+ ", getLastUpdateDate()=" + getLastUpdateDate() + ", getBusinessType()=" + getBusinessType()
				+ ", getProductObjectCode()=" + getProductObjectCode() + ", getPricingType()=" + getPricingType()
				+ ", getPricingTag()=" + getPricingTag() + ", getEffectiveDate()=" + getEffectiveDate()
				+ ", getTagExpirationDate()=" + getTagExpirationDate() + ", getBalanceType()=" + getBalanceType()
				+ ", getBranchNumber()=" + getBranchNumber() + ", getDateOfBirth()=" + getDateOfBirth()
				+ ", getMobilePhone()=" + getMobilePhone() + ", getZipCode()=" + getZipCode() + ", getHomePhone()="
				+ getHomePhone() + ", getCompanyPhone()=" + getCompanyPhone() + ", getContactPhone()="
				+ getContactPhone() + ", getContactName()=" + getContactName() + ", getMemberSince()="
				+ getMemberSince() + ", getCustomerSource()=" + getCustomerSource() + ", getBehaviorScore()="
				+ getBehaviorScore() + ", getCustomerLevel()=" + getCustomerLevel() + ", getAnnualIncome()="
				+ getAnnualIncome() + ", getSexCode()=" + getSexCode() + ", getResidencyStatus()="
				+ getResidencyStatus() + ", getMaritalStatus()=" + getMaritalStatus() + ", getOccupationCode()="
				+ getOccupationCode() + ", getPostRankCode()=" + getPostRankCode() + ", getTitleCode()="
				+ getTitleCode() + ", getPeriodOfOccupation()=" + getPeriodOfOccupation() + ", getHobby()=" + getHobby()
				+ ", getGuarantorFlag()=" + getGuarantorFlag() + ", getMarketerCode()=" + getMarketerCode()
				+ ", getSocialSecurityId()=" + getSocialSecurityId() + ", getSocialSecurityNumber()="
				+ getSocialSecurityNumber() + ", getCoreCustomerRemarkss()=" + getCoreCustomerRemarkss()
				+ ", getCoreCustomerBusinessTypes()=" + getCoreCustomerBusinessTypes() + ", getProductUnitCode()="
				+ getProductUnitCode() + ", getProductLineCode()=" + getProductLineCode() + ", getPostingCurrency1()="
				+ getPostingCurrency1() + ", getPostingCurrency2()=" + getPostingCurrency2()
				+ ", getPostingCurrency3()=" + getPostingCurrency3() + ", getPostingCurrency4()="
				+ getPostingCurrency4() + ", getPostingCurrency5()=" + getPostingCurrency5()
				+ ", getPostingCurrency6()=" + getPostingCurrency6() + ", getPostingCurrency7()="
				+ getPostingCurrency7() + ", getPostingCurrency8()=" + getPostingCurrency8()
				+ ", getPostingCurrency9()=" + getPostingCurrency9() + ", getPostingCurrency10()="
				+ getPostingCurrency10() + ", getCoBrandedNo()=" + getCoBrandedNo() + ", getMediaUnitCode()="
				+ getMediaUnitCode() + ", getMediaObjectCode()=" + getMediaObjectCode()
				+ ", getExternalIdentificationNo()=" + getExternalIdentificationNo() + ", getMainCustomerNo()="
				+ getMainCustomerNo() + ", getSubCustomerNo()=" + getSubCustomerNo() + ", getMainSupplyIndicator()="
				+ getMainSupplyIndicator() + ", getMediaUserName()=" + getMediaUserName() + ", getApplicationStaffNo()="
				+ getApplicationStaffNo() + ", getApplicationNumber()=" + getApplicationNumber()
				+ ", getExpirationDate()=" + getExpirationDate() + ", getPreviousExpirationDate()="
				+ getPreviousExpirationDate() + ", getPinDispatchMethod()=" + getPinDispatchMethod()
				+ ", getMediaDispatchMethod()=" + getMediaDispatchMethod() + ", getStatusCode()=" + getStatusCode()
				+ ", getActivationFlag()=" + getActivationFlag() + ", getActivationDate()=" + getActivationDate()
				+ ", getCreateDate()=" + getCreateDate() + ", getEmbosserName1()=" + getEmbosserName1()
				+ ", getEmbosserName2()=" + getEmbosserName2() + ", getEmbosserName3()=" + getEmbosserName3()
				+ ", getEmbosserName4()=" + getEmbosserName4() + ", getProductionCode()=" + getProductionCode()
				+ ", getProductionDate()=" + getProductionDate() + ", getPreviousProductionCode()="
				+ getPreviousProductionCode() + ", getPreviousProductionDate()=" + getPreviousProductionDate()
				+ ", getFormatCode()=" + getFormatCode() + ", getAccountCurrency()=" + getAccountCurrency()
				+ ", getModeName()=" + getModeName() + ", getLastProcessDate()=" + getLastProcessDate()
				+ ", getCurrProcessDate()=" + getCurrProcessDate() + ", getNextProcessDate()=" + getNextProcessDate()
				+ ", getOperationDate()=" + getOperationDate() + ", getCreditTreeId()=" + getCreditTreeId()
				+ ", getExcessPymtBusinessType()=" + getExcessPymtBusinessType() + ", getCoreMediaLabelInfos()="
				+ getCoreMediaLabelInfos() + ", getBindId()=" + getBindId() + ", getBindDate()=" + getBindDate()
				+ ", getUnbindDate()=" + getUnbindDate() + ", getNextBillDate()=" + getNextBillDate()
				+ ", getIsTransferCard()=" + getIsTransferCard() + ", getNonLogId()=" + getNonLogId() + ", getId()="
				+ getId() + ", getAccountId()=" + getAccountId() + ", getBusinessTypeCode()=" + getBusinessTypeCode()
				+ ", getOrganNo()=" + getOrganNo() + ", getAccountOrganizeTyp()=" + getAccountOrganizeTyp()
				+ ", getBusinessDebitCreditCode()=" + getBusinessDebitCreditCode() + ", getCycleModeFlag()="
				+ getCycleModeFlag() + ", getStatusUpdateDate()=" + getStatusUpdateDate() + ", getClosedDate()="
				+ getClosedDate() + ", getInterestProcessDate()=" + getInterestProcessDate() + ", getPaymentDueDate()="
				+ getPaymentDueDate() + ", getDelinquencyDate()=" + getDelinquencyDate()
				+ ", getAccountingStatusCode()=" + getAccountingStatusCode() + ", getAccountingStatusDate()="
				+ getAccountingStatusDate() + ", getPrevAccountingStatusCode()=" + getPrevAccountingStatusCode()
				+ ", getPrevAccountingStatusDate()=" + getPrevAccountingStatusDate() + ", getDirectDebitType()="
				+ getDirectDebitType() + ", getCycleDue()=" + getCycleDue() + ", getPrevCycleDue()=" + getPrevCycleDue()
				+ ", getAbsStatus()=" + getAbsStatus() + ", getCurrentCycleNumber()=" + getCurrentCycleNumber()
				+ ", getTotalAmtDue()=" + getTotalAmtDue() + ", getFlag()=" + getFlag() + ", getType()=" + getType()
				+ ", getPermLimit()=" + getPermLimit() + ", getBalanceUnitCode()=" + getBalanceUnitCode()
				+ ", getInterestStartDate()=" + getInterestStartDate() + ", getNodeTyp()=" + getNodeTyp()
				+ ", getGlobalTransSerialNo()=" + getGlobalTransSerialNo() + ", getIndexNo()=" + getIndexNo()
				+ ", getPageSize()=" + getPageSize() + ", toString()=" + super.toString() + ", getClass()=" + getClass()
				+ ", hashCode()=" + hashCode() + "]";
	}
