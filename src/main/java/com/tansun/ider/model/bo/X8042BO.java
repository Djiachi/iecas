 ...
 */
public class X8042BO extends BeanVO implements Serializable {

	private static final long serialVersionUID = 6500086981934927971L;
	...
	private String ecommTransB038AuthCode;
	...
	private BigDecimal ecommCreditDeduction;
	private String ecommCreditDeductionNode;
	private BigDecimal ecommOverpayDeduction;
	private String ecommBusinessTypeCde;
	private String ecommRvTransCurr;
	private BigDecimal ecommRvTransAmount;
	private String ecommRvBillCurr;
	private BigDecimal ecommRvBillAmount;
	private String ecommAuthOutsFlag;
	private String ecommAuthTyp;
	...
	public String getEcommAuthOutsFlag() {
		return ecommAuthOutsFlag;
	}
	...
	public String getEcommBusinessTypeCde() {
		return ecommBusinessTypeCde;
	}
	...
	public BigDecimal getEcommCreditDeduction() {
		return ecommCreditDeduction;
	}

	public String getEcommCreditDeductionNode() {
		return ecommCreditDeductionNode;
	}
	...
	public BigDecimal getEcommOverpayDeduction() {
		return ecommOverpayDeduction;
	}
	...
	public BigDecimal getEcommRvBillAmount() {
		return ecommRvBillAmount;
	}

	public String getEcommRvBillCurr() {
		return ecommRvBillCurr;
	}

	public BigDecimal getEcommRvTransAmount() {
		return ecommRvTransAmount;
	}

	public String getEcommRvTransCurr() {
		return ecommRvTransCurr;
	}

	public String getEcommTransB038AuthCode() {
		return ecommTransB038AuthCode;
	}
	...
	public void setEcommAuthOutsFlag(String ecommAuthOutsFlag) {
		this.ecommAuthOutsFlag = ecommAuthOutsFlag;
	}
	...
	public void setEcommAuthTyp(String ecommAuthTyp) {
		this.ecommAuthTyp = ecommAuthTyp;
	}
	...
	public void setEcommBusinessTypeCde(String ecommBusinessTypeCde) {
		this.ecommBusinessTypeCde = ecommBusinessTypeCde;
	}
	...
	public void setEcommCreditDeduction(BigDecimal ecommCreditDeduction) {
		this.ecommCreditDeduction = ecommCreditDeduction;
	}

	public void setEcommCreditDeductionNode(String ecommCreditDeductionNode) {
		this.ecommCreditDeductionNode = ecommCreditDeductionNode;
	}
	...
	public void setEcommOverpayDeduction(BigDecimal ecommOverpayDeduction) {
		this.ecommOverpayDeduction = ecommOverpayDeduction;
	}
	...
	public void setEcommRvBillAmount(BigDecimal ecommRvBillAmount) {
		this.ecommRvBillAmount = ecommRvBillAmount;
	}

	public void setEcommRvBillCurr(String ecommRvBillCurr) {
		this.ecommRvBillCurr = ecommRvBillCurr;
	}

	public void setEcommRvTransAmount(BigDecimal ecommRvTransAmount) {
		this.ecommRvTransAmount = ecommRvTransAmount;
	}

	public void setEcommRvTransCurr(String ecommRvTransCurr) {
		this.ecommRvTransCurr = ecommRvTransCurr;
	}

	public void setEcommTransB038AuthCode(String ecommTransB038AuthCode) {
		this.ecommTransB038AuthCode = ecommTransB038AuthCode;
	}
	...
	public String toString() {
		return "X8042BO [id=" + id + ", transProcessTm=" + transProcessTm + ", transProcessNumbr=" + transProcessNumbr
				...
				+ transDowngradeFlag + ", transChipFlag=" + transChipFlag + ", declineRsn=" + declineRsn
				+ ", declineInfo=" + declineInfo + ", ecommOperMode=" + ecommOperMode + ", ecommOperCurrency="
				+ ecommOperCurrency + ", ecommAuthSceneCde=" + ecommAuthSceneCde + ", ecommTxnCde=" + ecommTxnCde
				+ ", ecommContrlSceneCde=" + ecommContrlSceneCde + ", ecommDifferentCde=" + ecommDifferentCde
				+ ", ecommListProperties=" + ecommListProperties + ", ecommListCode=" + ecommListCode
				+ ", ecommTransLimitLevel=" + ecommTransLimitLevel + ", ecommTransLimitCde=" + ecommTransLimitCde
				+ ", ecommChBillCurr=" + ecommChBillCurr + ", ecommCustomerNo=" + ecommCustomerNo
				+ ", overpayAccountCde=" + overpayAccountCde + ", overpayAccountCurrency=" + overpayAccountCurrency
				+ ", authRequestTyp=" + authRequestTyp + ", ecommReverseTyp=" + ecommReverseTyp + ", userId=" + userId
				+ ", ecommCreditLimit=" + ecommCreditLimit + ", ecommAvailLimit=" + ecommAvailLimit + ", cashFlag="
				+ cashFlag + ", ecommVerifnRsltCvv=" + ecommVerifnRsltCvv + ", ecommVerifnRsltIcvv="
				+ ecommVerifnRsltIcvv + ", ecommVerifnRsltCvv2=" + ecommVerifnRsltCvv2 + ", ecommVerifnRsltCavv="
				+ ecommVerifnRsltCavv + ", ecommVerifnRsltPin=" + ecommVerifnRsltPin + ", ecommVerifnRsltArqc="
				+ ecommVerifnRsltArqc + ", ecommVerifnRsltExpDte=" + ecommVerifnRsltExpDte + ", ecommVerifnRsltPltNbrs="
				...
				+ ", ecommTransB038AuthCode=" + ecommTransB038AuthCode + ", ecommB041CardAccpt=" + ecommB041CardAccpt
				...
				+ ", ecommAuthCde=" + ecommAuthCde + ", ecommAuthResponseCde=" + ecommAuthResponseCde + ", gmtCreate="
				+ gmtCreate + ", timestamp=" + timestamp + ", version=" + version + ", ecommCreditDeduction="
				+ ecommCreditDeduction + ", ecommCreditDeductionNode=" + ecommCreditDeductionNode
				+ ", ecommOverpayDeduction=" + ecommOverpayDeduction + ", ecommBusinessTypeCde=" + ecommBusinessTypeCde
				+ ", ecommRvTransCurr=" + ecommRvTransCurr + ", ecommRvTransAmount=" + ecommRvTransAmount
				+ ", ecommRvBillCurr=" + ecommRvBillCurr + ", ecommRvBillAmount=" + ecommRvBillAmount
				+ ", ecommAuthOutsFlag=" + ecommAuthOutsFlag + ", ecommAuthTyp=" + ecommAuthTyp + "]";
	}
