 ...
 *
 */
public class X5438BO extends BeanVO implements Serializable {
	
	private static final long serialVersionUID = -1400458809945570680L;
	/** 活动与构件对应关系表 */
	...
	public boolean isIfTrans() {
		return ifTrans;
	}

	public void setIfTrans(boolean ifTrans) {
	...
	public String toString() {
		return "X5435BO [queryType=" + queryType + ", idNumber=" + idNumber + ", externalIdentificationNo="
				...
				+ logLevel + ", startDate=" + startDate + ", endDate=" + endDate + ", transProperty=" + transProperty
