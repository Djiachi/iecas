...
public class X7070BO extends BeanVO implements Serializable {
	...
	public void setTradeDateDate(String tradeDate) {
    ...
    public String toString() {
        return "X7070BO [cardNo=" + cardNo + ", stageType=" + stageType 
        		+  ", tradeDate=" + tradeDate + "]";
    }
