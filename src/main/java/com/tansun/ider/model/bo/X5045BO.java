...
public class X5045BO {
	...
	private String ecommProdLineCode;// 产品线代码
	/** 活动与构件对应关系表 */
	...
	public String getBudgetOrgArea() {
		return budgetOrgArea;
	}

	public void setBudgetOrgArea(String budgetOrgArea) {
		this.budgetOrgArea = budgetOrgArea;
	}
	...
	public String getEcommProdLineCode() {
		return ecommProdLineCode;
	}

	public void setEcommProdLineCode(String ecommProdLineCode) {
		this.ecommProdLineCode = ecommProdLineCode;
	}
