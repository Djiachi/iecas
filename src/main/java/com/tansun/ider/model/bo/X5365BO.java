...
import com.tansun.ider.model.vo.X5365VO;
 ...
 * @date 2018年7月3日
 */
public class X5365BO implements Serializable{
     ...
     */
    public void setList(List<X5365VO> list) {
        this.list = list;
    }
    ...
    public String toString() {
        return "X5365BO [accountNo=" + accountNo + ", currencyCode=" + currencyCode + ", trialDate=" + trialDate
                + ", totalAmount=" + totalAmount + ", principal=" + principal + ", interest=" + interest + ", fee="
                + fee + ", list=" + list + "]";
    }
