 ...
 * @Desc: 账户还款历史查询
 * @Author lianhuan
 * @Date 2018年6月14日下午5:32:03
 */

public class X5320BO extends BeanVO {

    /**
	 * 
	 */
	private static final long serialVersionUID = 5798590755925600080L;
	/** 针对金融工程分页查询 第几页 */
    private int pageNum;
    /** 每页有多少条记录 */
	...
	public X5320BO(CoreEventActivityRel coreEventActivityRel, List<CoreActivityArtifactRel> activityArtifactList,
			String globalEventNo, String ecommEventId, String customerNo, String institutionId, String operationMode,
			String customerName, String idType, String idNumber, String city, String customerType, String billDay,
			String customerStatus, List<CoreCustomerAddr> coreCoreCustomerAddrs, String remarkInfo,
			String lastUpdateUserid, Integer serialNo, String lastUpdateDate, String currencyCode, String businessType,
			String productObjectCode, String pricingType, String pricingTag, Date effectiveDate, Date tagExpirationDate,
			String balanceType, String branchNumber, String dateOfBirth, String mobilePhone, String zipCode,
			...
			String socialSecurityNumber, List<CoreCustomerRemarks> coreCustomerRemarkss,
			List<CoreCustomerBusinessType> coreCustomerBusinessTypes, String productUnitCode, String productLineCode,
			String postingCurrency1, String postingCurrency2, String postingCurrency3, String postingCurrency4,
			String postingCurrency5, String postingCurrency6, String postingCurrency7, String postingCurrency8,
			String postingCurrency9, String postingCurrency10, String coBrandedNo, String mediaUnitCode,
			String mediaObjectCode, String externalIdentificationNo, String mainCustomerNo, String subCustomerNo,
			String mainSupplyIndicator, String mediaUserName, String applicationStaffNo, String applicationNumber,
			String expirationDate, String previousExpirationDate, String pinDispatchMethod, String mediaDispatchMethod,
			String statusCode, String activationFlag, String activationDate, String createDate, String embosserName1,
			String embosserName2, String embosserName3, String embosserName4, String productionCode,
			String productionDate, String previousProductionCode, String previousProductionDate, String formatCode,
			String accountCurrency, String modeName, String lastProcessDate, String currProcessDate,
			String nextProcessDate, String operationDate, String creditTreeId, String excessPymtBusinessType,
			List<CoreMediaLabelInfo> coreMediaLabelInfos, String bindId, String bindDate, String unbindDate,
			String nextBillDate, String isTransferCard, String nonLogId, String id, String accountId,
			String businessTypeCode, String organNo, String accountOrganizeTyp, String businessDebitCreditCode,
			String cycleModeFlag, String statusUpdateDate, String closedDate, String interestProcessDate,
			String paymentDueDate, String delinquencyDate, String accountingStatusCode, String accountingStatusDate,
			String prevAccountingStatusCode, String prevAccountingStatusDate, String directDebitType, String cycleDue,
			String prevCycleDue, String absStatus, Integer currentCycleNumber, BigDecimal totalAmtDue, String flag) {
		super();
	...
	public String toString() {
		return "X5320BO [coreEventActivityRel=" + coreEventActivityRel + ", activityArtifactList="
				+ activityArtifactList + ", globalEventNo=" + globalEventNo + ", ecommEventId=" + ecommEventId
				+ ", customerNo=" + customerNo + ", institutionId=" + institutionId + ", operationMode=" + operationMode
				+ ", customerName=" + customerName + ", idType=" + idType + ", idNumber=" + idNumber + ", city=" + city
				+ ", customerType=" + customerType + ", billDay=" + billDay + ", customerStatus=" + customerStatus
				...
				+ lastUpdateDate + ", currencyCode=" + currencyCode + ", businessType=" + businessType
				+ ", productObjectCode=" + productObjectCode + ", pricingType=" + pricingType + ", pricingTag="
				+ pricingTag + ", effectiveDate=" + effectiveDate + ", tagExpirationDate=" + tagExpirationDate
				+ ", balanceType=" + balanceType + ", branchNumber=" + branchNumber + ", dateOfBirth=" + dateOfBirth
				...
				+ ", socialSecurityNumber=" + socialSecurityNumber + ", coreCustomerRemarkss=" + coreCustomerRemarkss
				+ ", coreCustomerBusinessTypes=" + coreCustomerBusinessTypes + ", productUnitCode=" + productUnitCode
				+ ", productLineCode=" + productLineCode + ", postingCurrency1=" + postingCurrency1
				+ ", postingCurrency2=" + postingCurrency2 + ", postingCurrency3=" + postingCurrency3
				+ ", postingCurrency4=" + postingCurrency4 + ", postingCurrency5=" + postingCurrency5
				+ ", postingCurrency6=" + postingCurrency6 + ", postingCurrency7=" + postingCurrency7
				+ ", postingCurrency8=" + postingCurrency8 + ", postingCurrency9=" + postingCurrency9
				+ ", postingCurrency10=" + postingCurrency10 + ", coBrandedNo=" + coBrandedNo + ", mediaUnitCode="
				+ mediaUnitCode + ", mediaObjectCode=" + mediaObjectCode + ", externalIdentificationNo="
				+ externalIdentificationNo + ", mainCustomerNo=" + mainCustomerNo + ", subCustomerNo=" + subCustomerNo
				+ ", mainSupplyIndicator=" + mainSupplyIndicator + ", mediaUserName=" + mediaUserName
				+ ", applicationStaffNo=" + applicationStaffNo + ", applicationNumber=" + applicationNumber
				+ ", expirationDate=" + expirationDate + ", previousExpirationDate=" + previousExpirationDate
				+ ", pinDispatchMethod=" + pinDispatchMethod + ", mediaDispatchMethod=" + mediaDispatchMethod
				+ ", statusCode=" + statusCode + ", activationFlag=" + activationFlag + ", activationDate="
				+ activationDate + ", createDate=" + createDate + ", embosserName1=" + embosserName1
				+ ", embosserName2=" + embosserName2 + ", embosserName3=" + embosserName3 + ", embosserName4="
				+ embosserName4 + ", productionCode=" + productionCode + ", productionDate=" + productionDate
				+ ", previousProductionCode=" + previousProductionCode + ", previousProductionDate="
				+ previousProductionDate + ", formatCode=" + formatCode + ", accountCurrency=" + accountCurrency
				+ ", modeName=" + modeName + ", lastProcessDate=" + lastProcessDate + ", currProcessDate="
				+ currProcessDate + ", nextProcessDate=" + nextProcessDate + ", operationDate=" + operationDate
				+ ", creditTreeId=" + creditTreeId + ", excessPymtBusinessType=" + excessPymtBusinessType
				+ ", coreMediaLabelInfos=" + coreMediaLabelInfos + ", bindId=" + bindId + ", bindDate=" + bindDate
				+ ", unbindDate=" + unbindDate + ", nextBillDate=" + nextBillDate + ", isTransferCard=" + isTransferCard
				+ ", nonLogId=" + nonLogId + ", id=" + id + ", accountId=" + accountId + ", businessTypeCode="
				+ businessTypeCode + ", organNo=" + organNo + ", accountOrganizeTyp=" + accountOrganizeTyp
				+ ", businessDebitCreditCode=" + businessDebitCreditCode + ", cycleModeFlag=" + cycleModeFlag
				+ ", statusUpdateDate=" + statusUpdateDate + ", closedDate=" + closedDate + ", interestProcessDate="
				+ interestProcessDate + ", paymentDueDate=" + paymentDueDate + ", delinquencyDate=" + delinquencyDate
				+ ", accountingStatusCode=" + accountingStatusCode + ", accountingStatusDate=" + accountingStatusDate
				+ ", prevAccountingStatusCode=" + prevAccountingStatusCode + ", prevAccountingStatusDate="
				+ prevAccountingStatusDate + ", directDebitType=" + directDebitType + ", cycleDue=" + cycleDue
				+ ", prevCycleDue=" + prevCycleDue + ", absStatus=" + absStatus + ", currentCycleNumber="
				+ currentCycleNumber + ", totalAmtDue=" + totalAmtDue + ", flag=" + flag + "]";
	}
