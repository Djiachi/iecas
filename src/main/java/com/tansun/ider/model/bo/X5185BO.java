 ...
 * @Desc:封锁码更新
 * @Author wt
 * @Date 2018年5月15日 下午2:44:03
 */
public class X5185BO {
	...
	// public List<CoreProductLineBillDay> getListCoreProductLineBillDays() {
	// return listCoreProductLineBillDays;
	// }
	// public void setListCoreProductLineBillDays(List<CoreProductLineBillDay>
	// listCoreProductLineBillDays) {
	// this.listCoreProductLineBillDays = listCoreProductLineBillDays;
	// }
