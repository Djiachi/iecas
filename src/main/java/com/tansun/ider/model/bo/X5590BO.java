...
import com.tansun.ider.dao.beta.entity.CoreArtifactElementRel;
...
public class X5590BO extends BeanVO implements Serializable{

	private static final long serialVersionUID = -5684821046383676965L;
	/** 运营模式 [3,0]  */
    private String operationMode;
    /** P：产品对象 M：媒介对象 A：业务类型 ，对应账户类构件 B：余额对象 O:运营模式 [1,0] Not NULL */
    private String objectType;
    /** 对象代码 如果对象类型为'O'，则对象代码为全空 [9,0] */
    ...
    /** 构件关联元件 */
    private List<CoreArtifactElementRel> list;
    /** 事件编号 [14,0] Not NULL */
    ...
    public List<CoreArtifactElementRel> getList() {
        return list;
    }

    public void setList(List<CoreArtifactElementRel> list) {
        this.list = list;
    }

    @Override
    public String toString() {
        return "X5515BO [operationMode=" + operationMode + ", objectType=" + objectType + ", objectCode=" + objectCode
                + ", artifactNo=" + artifactNo + ", elementNo=" + elementNo + ", list=" + list + "]";
    }
