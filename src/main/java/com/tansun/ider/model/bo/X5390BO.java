 ...
 * @date 2018年8月13日
 */
public class X5390BO extends BeanVO implements Serializable {
	...
	public String toString() {
		return "X5390BO [currencyCode=" + currencyCode + ", BillDate=" + billDate
				+ ", businessProgramNo=" + businessProgramNo + ", productObjectCode=" + productObjectCode
				+ ", businessTypeCode=" + businessTypeCode +  ", customerNo=" + customerNo +"]";
	}
}
