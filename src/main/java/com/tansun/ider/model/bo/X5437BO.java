 ...
 *
 */
public class X5437BO extends BeanVO implements Serializable {
	private static final long serialVersionUID = 3580880684310714701L;
	/** 币种 : 币种 [3,0] Not NULL */
	...
	public String toString() {
		return "X5437BO [currencyCode=" + currencyCode + ", BillDate=" + billDate
