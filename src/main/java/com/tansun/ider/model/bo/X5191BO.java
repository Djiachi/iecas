...
public class X5191BO extends BeanVO implements Serializable{
	
	
	private ArrayList<String> levelCodeList;
	private String sceneTriggerLevelCode;
	/** 生效码范围 */
	private String effectivenessCodeScope;
	/** 是否转卡标志 */
	...
	private String externalIdentificationNoIn;
    /** 媒介记录表 */
    private List<CoreMediaBasicInfo> coreMediaBasicInfoList;
    ...
    //------------------------------------------------------
	/** 场景触发对象 */
	@NotBlank(message = "场景触发对象必须输入!")
	private String sceneTriggerObject;
	/** 生效码序号 */
	private String effectivenessCodeScene;
	/** 生效码类别 */
	private String effectivenessCodeType;
	/** 法人实体编号 */
	private String corporation;	
	/** 封锁码标识 blockFlag */
	private String blockFlag;
	/** 维护人员代码 [20,0] Not NULL */
	@NotBlank(message = "操作员Id必须输入!")
	...
	@NotBlank(message = "SP事件编号必须输入!")
	private String spEventNo; // 事件ID
	private String occurrDate; // 发生日期
	private String occurrTime; // 发生时间
	// 查询事件编号表
	/** 对应余额对象 */
	private String ecommBalanceObject;
	/** 事件编号 */
	private String ecommEventNo;
	/** 事件记账方向 */
	private String ecommEventBookKeepingDirec;
	/** 还款类型L */
	private String ecommPaymentType;
	/** 交易识别代码 */
	private String ecommTransIdentificationCode;
	/** 客户号 */
	@NotBlank(message = "客户号必须输入!")
	private String customerNo;
	/** 所属机构 */
	private String institutionId;
	/** 运营模式 */
	@NotBlank(message = "运营模式必须输入!")
	...
	/** 产品线账单日 */
	// private List<CoreProductLineBillDay> listCoreProductLineBillDays;
	/** 产品线统一日期 */
	...
	/** 优先级 [10,0] */
	protected String blockCodePrioriy;
	/** 封锁码场景描述 [50,0] */
	...
	public String getExternalIdentificationNoIn() {
		return externalIdentificationNoIn;
	}
	public void setExternalIdentificationNoIn(String externalIdentificationNoIn) {
		this.externalIdentificationNoIn = externalIdentificationNoIn;
	}
	public List<CoreMediaBasicInfo> getCoreMediaBasicInfoList() {
		return coreMediaBasicInfoList;
	}
	public void setCoreMediaBasicInfoList(List<CoreMediaBasicInfo> coreMediaBasicInfoList) {
	...
	public String getEcommBalanceObject() {
		return ecommBalanceObject;
	}
	public void setEcommBalanceObject(String ecommBalanceObject) {
		this.ecommBalanceObject = ecommBalanceObject;
	}
	public String getEcommEventNo() {
		return ecommEventNo;
	}
	public void setEcommEventNo(String ecommEventNo) {
		this.ecommEventNo = ecommEventNo;
	}
	public String getEcommEventBookKeepingDirec() {
		return ecommEventBookKeepingDirec;
	}
	public void setEcommEventBookKeepingDirec(String ecommEventBookKeepingDirec) {
		this.ecommEventBookKeepingDirec = ecommEventBookKeepingDirec;
	}
	public String getEcommPaymentType() {
		return ecommPaymentType;
	}
	public void setEcommPaymentType(String ecommPaymentType) {
		this.ecommPaymentType = ecommPaymentType;
	}
	public String getEcommTransIdentificationCode() {
		return ecommTransIdentificationCode;
	}
	public void setEcommTransIdentificationCode(String ecommTransIdentificationCode) {
		this.ecommTransIdentificationCode = ecommTransIdentificationCode;
	}
	...
	public String getBlockCodePrioriy() {
		return blockCodePrioriy;
	}
	public void setBlockCodePrioriy(String blockCodePrioriy) {
	...
	public String getSceneTriggerLevelCode() {
		return sceneTriggerLevelCode;
	}
	public void setSceneTriggerLevelCode(String sceneTriggerLevelCode) {
		this.sceneTriggerLevelCode = sceneTriggerLevelCode;
	}
	...
	public void setLevelCodeList(ArrayList<String> levelCodeList) {
		this.levelCodeList = levelCodeList;
	}
	@Override
	public String toString() {
		return "X5415BO [supIdType=" + supIdType + ", supIdNumber=" + supIdNumber + ", applicationCardType="
				+ applicationCardType + ", externalIdentificationNoIn=" + externalIdentificationNoIn
				+ ", coreMediaBasicInfoList=" + coreMediaBasicInfoList + ", isNew=" + isNew + ", whetherProcess="
				+ whetherProcess + ", serviceCode=" + serviceCode + ", currLogFlag=" + currLogFlag + ", activityNo="
				+ activityNo + ", businessProgramNo=" + businessProgramNo + ", productForm=" + productForm
				+ ", pageNum=" + pageNum + ", pageSize=" + pageSize + ", indexNo=" + indexNo + ", paymentMark="
				+ paymentMark + ", country=" + country + ", retailVerifyPswFlag=" + retailVerifyPswFlag
				+ ", retailVerifyPswAmount=" + retailVerifyPswAmount + ", type=" + type + ", permLimit=" + permLimit
				+ ", creditNodeNo=" + creditNodeNo + ", creditLimit=" + creditLimit + ", ecommEventId=" + ecommEventId
				+ ", transferMediaCode=" + transferMediaCode + ", loanAmount=" + loanAmount + ", loanCurrencyCode="
				+ loanCurrencyCode + ", repayMode=" + repayMode + ", loanNumber=" + loanNumber + ", monthSupplyPeriod="
				+ monthSupplyPeriod + ", loanTermUnit=" + loanTermUnit + ", payLoanDate=" + payLoanDate
				+ ", loanExpira=" + loanExpira + ", receiptAccount=" + receiptAccount + ", ReceiptBranchNUM="
				+ ReceiptBranchNUM + ", loanRate=" + loanRate + ", repayPrincipal=" + repayPrincipal
				+ ", repaymentDateType=" + repaymentDateType + ", repayDay=" + repayDay + ", freeDays=" + freeDays
				+ ", creditType=" + creditType + ", limitEffectvDate=" + limitEffectvDate + ", limitExpireDate="
				+ limitExpireDate + ", budgetOrgCode=" + budgetOrgCode + ", sceneTriggerObject=" + sceneTriggerObject
				+ ", effectivenessCodeScene=" + effectivenessCodeScene + ", effectivenessCodeType="
				+ effectivenessCodeType + ", corporation=" + corporation + ", blockFlag=" + blockFlag + ", operatorId="
				+ operatorId + ", coreEventActivityRel=" + coreEventActivityRel + ", activityArtifactList="
				+ activityArtifactList + ", eventNo=" + eventNo + ", spEventNo=" + spEventNo + ", occurrDate="
				+ occurrDate + ", occurrTime=" + occurrTime + ", ecommBalanceObject=" + ecommBalanceObject
				+ ", ecommEventNo=" + ecommEventNo + ", ecommEventBookKeepingDirec=" + ecommEventBookKeepingDirec
				+ ", ecommPaymentType=" + ecommPaymentType + ", ecommTransIdentificationCode="
				+ ecommTransIdentificationCode + ", customerNo=" + customerNo + ", institutionId=" + institutionId
				+ ", operationMode=" + operationMode + ", customerName=" + customerName + ", idType=" + idType
				+ ", idNumber=" + idNumber + ", city=" + city + ", customerType=" + customerType + ", billDay="
				+ billDay + ", customerStatus=" + customerStatus + ", coreCoreCustomerAddrs=" + coreCoreCustomerAddrs
				+ ", remarkInfo=" + remarkInfo + ", lastUpdateUserid=" + lastUpdateUserid + ", serialNo=" + serialNo
				+ ", lastUpdateDate=" + lastUpdateDate + ", currencyCode=" + currencyCode + ", businessType="
				+ businessType + ", productObjectCode=" + productObjectCode + ", pricingType=" + pricingType
				+ ", pricingTag=" + pricingTag + ", effectiveDate=" + effectiveDate + ", tagExpirationDate="
				+ tagExpirationDate + ", balanceType=" + balanceType + ", branchNumber=" + branchNumber
				+ ", dateOfBirth=" + dateOfBirth + ", mobilePhone=" + mobilePhone + ", zipCode=" + zipCode
				+ ", homePhone=" + homePhone + ", companyPhone=" + companyPhone + ", contactPhone=" + contactPhone
				+ ", contactName=" + contactName + ", memberSince=" + memberSince + ", customerSource=" + customerSource
				+ ", behaviorScore=" + behaviorScore + ", customerLevel=" + customerLevel + ", annualIncome="
				+ annualIncome + ", sexCode=" + sexCode + ", residencyStatus=" + residencyStatus + ", maritalStatus="
				+ maritalStatus + ", occupationCode=" + occupationCode + ", postRankCode=" + postRankCode
				+ ", titleCode=" + titleCode + ", periodOfOccupation=" + periodOfOccupation + ", hobby=" + hobby
				+ ", guarantorFlag=" + guarantorFlag + ", marketerCode=" + marketerCode + ", socialSecurityId="
				...
				+ totalAmtDue + ", flag=" + flag + ", balanceUnitCode=" + balanceUnitCode + ", cycleNumber="
				+ cycleNumber + ", balance=" + balance + ", annualInterestRate=" + annualInterestRate
				+ ", accumulatedInterest=" + accumulatedInterest + ", currentMinPayment=" + currentMinPayment
				+ ", balanceObjectCode=" + balanceObjectCode + ", nextInterestBillingDate=" + nextInterestBillingDate
				+ ", prevInterestBillingDate=" + prevInterestBillingDate + ", assetProperties=" + assetProperties
				+ ", endDate=" + endDate + ", lastInterestRate=" + lastInterestRate + ", lastInterestRateExpirDate="
				+ lastInterestRateExpirDate + ", firstBillingCycle=" + firstBillingCycle + ", recordNumber="
				+ recordNumber + ", cardAssociations=" + cardAssociations + ", magneticChannel1=" + magneticChannel1
				+ ", magneticChannel2=" + magneticChannel2 + ", magneticChannel3=" + magneticChannel3
				+ ", cardholderName=" + cardholderName + ", postCode=" + postCode + ", phoneNumber=" + phoneNumber
				+ ", mediaObjectType=" + mediaObjectType + ", extBuffer=" + extBuffer + ", contactAddress="
				+ contactAddress + ", contactPostCode=" + contactPostCode + ", contactMobilePhone=" + contactMobilePhone
				+ ", listCoreCustomerUnifyInfos=" + listCoreCustomerUnifyInfos + ", listCoreMediaBinds="
				+ listCoreMediaBinds + ", blockCodeType=" + blockCodeType + ", blockCodeScene=" + blockCodeScene
				+ ", blockCodePrioriy=" + blockCodePrioriy + ", blockCodeDesc=" + blockCodeDesc + ", blockCodeScope="
				+ blockCodeScope + ", listCoreProducts=" + listCoreProducts + ", listcoreMediaBasicInfo="
				+ listcoreMediaBasicInfo + ", listCoreAccount=" + listCoreAccount + ", elementNo=" + elementNo
				+ ", contrlSerialNo=" + contrlSerialNo + ", contrlLevel=" + contrlLevel + ", levelCode=" + levelCode
				+ ", contrlSource=" + contrlSource + ", contrlStartDate=" + contrlStartDate + ", contrlEndDate="
				+ contrlEndDate + ", startDate=" + startDate + ", listX5120VOs=" + listX5120VOs + ", globalEventNo="
				+ globalEventNo + ", delay=" + delay + ", invalidReason=" + invalidReason + "]";
	}
