 ...
 * @Desc:媒介单元代码新增
 * @Author wt
 * @Date 2018年5月15日 下午3:45:03
 */
public class X5190BO {
	...
	private Integer blockCodeScene;
	/** 优先级 [10,0] */
	private Integer blockCodePrioriy;
	/** 封锁码场景描述 [50,0] */
	private String blockCodeDesc;
	/** 封封锁范围 C：客户级A：业务类型级P：产品级M：媒介级 [50,0] */
	@NotBlank(message = "验证字符串非null，且长度必须大于0 ")
	private String blockCodeScope;
	private List<CoreProduct> listCoreProducts;
	private List<CoreMediaBasicInfo> listcoreMediaBasicInfo;
