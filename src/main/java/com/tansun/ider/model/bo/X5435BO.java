 ...
 */
public class X5435BO extends BeanVO implements Serializable {
    ...
    private String eventNoLikeStr;
    private  String accFlag;
    private  String pageFlag;
    /**日志子层级*/
    private  String subLogLevel;
    ...
    public String getEventNoLikeStr() {
		return eventNoLikeStr;
	}

	public void setEventNoLikeStr(String eventNoLikeStr) {
		this.eventNoLikeStr = eventNoLikeStr;
	}
    ...
    public String toString() {
        return "X5435BO{" +
                ...
                ", globalSerialNumbrRelative='" + globalSerialNumbrRelative + '\'' +
                ", logLevel='" + logLevel + '\'' +
                ", startDate='" + startDate + '\'' +
                ", endDate='" + endDate + '\'' +
                ...
                ", changeCycleNumberMark=" + changeCycleNumberMark +
                ", eventNoList=" + eventNoList +
                ", flag='" + flag + '\'' +
                ", operationMode='" + operationMode + '\'' +
                ", eventNoLikeStr='" + eventNoLikeStr + '\'' +
                ", accFlag='" + accFlag + '\'' +
                ", pageFlag='" + pageFlag + '\'' +
                '}';
    }
