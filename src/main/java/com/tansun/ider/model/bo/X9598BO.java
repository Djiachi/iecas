 ...
 */
public class X9598BO extends BeanVO implements Serializable {
	...
	/** 金融活动日志S类 */
	protected List<CoreSpecialActivityLog> coreSpecialActivityLogList;

	public List<CoreSpecialActivityLog> getCoreSpecialActivityLogList() {
		return coreSpecialActivityLogList;
	}

	public void setCoreSpecialActivityLogList(List<CoreSpecialActivityLog> coreSpecialActivityLogList) {
		this.coreSpecialActivityLogList = coreSpecialActivityLogList;
	}
