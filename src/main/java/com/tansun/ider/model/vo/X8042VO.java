...
public class X8042VO  extends BeanVO implements Serializable {

	private static final long serialVersionUID = -5137194813860765641L;
	...
	// 交易日期
	private String ecommB007GmtDate;
	// 交易时间
	private String ecommB007GmtTime;
	
	public String getEcommB007GmtDate() {
		return ecommB007GmtDate;
	}

	public void setEcommB007GmtDate(String ecommB007GmtDate) {
		this.ecommB007GmtDate = ecommB007GmtDate;
	}

	public String getEcommB007GmtTime() {
		return ecommB007GmtTime;
	}

	public void setEcommB007GmtTime(String ecommB007GmtTime) {
		this.ecommB007GmtTime = ecommB007GmtTime;
	}
	...
	private String ecommGlobalSerialNum;
	private Integer version;
	private String ecommPreAuthStatus;
	/** 交易币种-冲正使用 [3,0] */
    protected String ecommRvTransCurr;
    /** 交易金额-冲正使用 [18,0] */
    protected BigDecimal ecommRvTransAmount;
    /** 入账币种-冲正使用 [3,0] */
    protected String ecommRvBillCurr;
    /** 入账金额-冲正使用 [18,0] */
    protected BigDecimal ecommRvBillAmount;
    ...
    public String getEcommGlobalSerialNum() {
		return ecommGlobalSerialNum;
	}

	public String getEcommPreAuthStatus() {
		return ecommPreAuthStatus;
	}

	public void setEcommPreAuthStatus(String ecommPreAuthStatus) {
		this.ecommPreAuthStatus = ecommPreAuthStatus;
	}

	public void setEcommGlobalSerialNum(String ecommGlobalSerialNum) {
		this.ecommGlobalSerialNum = ecommGlobalSerialNum;
	}
	...
	public String toString() {
		return "X8042VO [id=" + id + ", transProcessTm=" + transProcessTm + ", transProcessNumbr=" + transProcessNumbr
				+ ", ecommB002PanNbr=" + ecommB002PanNbr + ", ecommB007GmtDateTime=" + ecommB007GmtDateTime
				+ ", ecommB007GmtDate=" + ecommB007GmtDate + ", ecommB007GmtTime=" + ecommB007GmtTime
				...
				+ gmtCreate + ", timestamp=" + timestamp + ", ecommGlobalSerialNum=" + ecommGlobalSerialNum
				+ ", version=" + version + ", ecommPreAuthStatus=" + ecommPreAuthStatus + "]";
	}
