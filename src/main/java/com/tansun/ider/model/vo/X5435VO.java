 ...
 * 交易历史查询
 * 
 * @author yanyingzhao 2019年06月28日
 */
public class X5435VO extends BeanVO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8363315076068813808L;
	protected String id;
	/** 客户号 [12,0] */
	...
	/**
	 * 外部识别号 格式：000+BBBBBB+sssssssss+C BBBBB:Bin号； sssssssss：按BIN的顺序号（乱序）；C：校验位
	 * [32,0]
	 */
    ...
    //dpan识别号
    private String dpanExternalIdentificationNo;
    /** 资产转变阶段:PACK-封包,TRSF-转让,REPO-回购 [4,0] */
    private String capitalStage;
    /** 资产转出机构代码 [25,0] */
    private String capitalOrganizationCode;
    private String transTime;
    private String accountingStatusCodeDesc;
    private String operationMode;
    /** 原始交易日期 贷方交易专用字段 yyyy-MM-dd [10,0] */
    protected String oriTransDate;
    /** 起息日 [10,0] */
    protected String interestStartDate;
    /** 已退货金额 [18,0] */
    private BigDecimal rejectedAmount;
	/** 日志子层级 [3,0] */
	protected String subLogLevel;

	/** 产品描述 */
	private String productDesc;
	private List<CoreTransHist> children;
	...
	public List<CoreTransHist> getChildren() {
		return children;
	}

	public void setChildren(List<CoreTransHist> children) {
	...
	public String getSubLogLevel() {
		return subLogLevel;
	}

	public void setSubLogLevel(String subLogLevel) {
