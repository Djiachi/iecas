 ...
 */
@Service
public class X5345BusImpl implements X5345Bus {
	...
	public Object busExecute(X5345BO x5345bo) throws Exception {
		...
		coreCustomerUnifyInfoSqlBuilder.andCycleNumberNotEqualTo(0);
		coreCustomerUnifyInfoSqlBuilder.orderByCycleNumber(true);
